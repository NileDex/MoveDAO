            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center mb-16">
              ...
              <div className="flex justify-center lg:justify-end">
                <div className="relative group">
                  <div className="absolute -inset-2 bg-gradient-to-r from-indigo-500/10 via-purple-500/10 to-blue-500/10 rounded-2xl blur-xl  "></div>
                  <div className="relative bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 w-48 h-48 flex items-center justify-center">
                    <AiOutlineEye className="w-20 h-20 text-white  " />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="flex justify-center lg:justify-end">
                <div className="relative group">
                  ...
                  <div className="relative bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 w-48 h-48 flex items-center justify-center scale-x-[-1]">
                    <HiOutlineUsers className="w-20 h-20 text-white  " />
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* CTA Section */}
          <div className="text-center">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="inline-block p-0.5 rounded-lg font-semibold text-base sm:text-lg "
              style={{
