...
const Home: React.FC = () => {
  return (
    <div className="min-h-screen bg-dark-950 text-white relative overflow-hidden">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center py-12 sm:py-16">
        ...
        <div className="relative z-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
          <div className="flex flex-col items-center space-y-8 sm:space-y-12">
            {/* Title and Learn More button - Now at the top */}
            ...
            {/* Hero Image - Now in the middle */}
            <div className="relative flex justify-center">
              <div className="relative">
                <div className="absolute -inset-2 bg-gradient-to-r from-indigo-500/10 via-purple-500/10 to-blue-500/10 rounded-3xl blur-lg"></div>
                <div className="relative bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
                  <img 
                    src={heroImage} 
                    alt="Move DAO Hero" 
                    className="w-full max-w-lg lg:max-w-2xl xl:max-w-3xl h-auto object-contain rounded-xl"
                  />
                </div>
              </div>
            </div>
      ...
      <div className="relative z-10 bg-dark-950">
        ...
        <section className="px-4 sm:px-6 py-12 sm:py-16 lg:px-8 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 sm:p-8  h-full flex flex-col">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 sm:p-8  md:col-span-2 lg:col-span-1 h-full flex flex-col">
        ...
        <section className="px-4 sm:px-6 py-12 sm:py-16 lg:px-8 max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-2xl mx-auto px-2 sm:px-0 leading-relaxed">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0">
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <span className="text-lg sm:text-xl font-bold">Oval</span>
              </div>
